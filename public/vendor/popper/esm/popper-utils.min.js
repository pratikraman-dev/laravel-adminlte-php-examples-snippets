...
var e = 'undefined' != typeof window && 'undefined' != typeof document && 'undefined' != typeof navigator, f = e && !!(window.MSInputMethodContext && document.documentMode), g = e && /MSIE 10/.test(navigator.userAgent);
function h(a) {
...
function m(a) {
    var b = 1 < arguments.length && arguments[1] !== void 0 ? arguments[1] : 'top', c = 'top' === b ? 'scrollTop' : 'scrollLeft', d = a.nodeName;
    if ('BODY' === d || 'HTML' === d) {
...
function n(a, b) {
    var c = 2 < arguments.length && void 0 !== arguments[2] && arguments[2], d = m(b, 'top'), e = m(b, 'left'), f = c ? -1 : 1;
...
function q(a) {
    var b = a.body, c = a.documentElement, d = h(10) && getComputedStyle(c);
...
function t(b) {
    ...
    }, g = 'HTML' === b.nodeName ? q(b.ownerDocument) : {}, i = g.width || b.clientWidth || f.width, j = g.height || b.clientHeight || f.height, k = b.offsetWidth - i, l = b.offsetHeight - j;
    if (k || l) {
        var n = a(b);
...
function u(b, d) {
    var e = Math.max, f = 2 < arguments.length && void 0 !== arguments[2] && arguments[2], g = h(10), i = 'HTML' === d.nodeName, j = t(b), k = t(d), l = c(b), m = a(d), o = parseFloat(m.borderTopWidth, 10), p = parseFloat(m.borderLeftWidth, 10);
    ...
    if (q.marginTop = 0, q.marginLeft = 0, !g && i) {
        var r = parseFloat(m.marginTop, 10), u = parseFloat(m.marginLeft, 10);
...
function v(a) {
    var b = Math.max, c = 1 < arguments.length && void 0 !== arguments[1] && arguments[1], d = a.ownerDocument.documentElement, e = u(a, d), f = b(d.clientWidth, window.innerWidth || 0), g = b(d.clientHeight, window.innerHeight || 0), h = c ? 0 : m(d), i = c ? 0 : m(d, 'left'), j = {
...
function y(a, e, f, g) {
    ...
    if ('viewport' === g)i = v(j, h); else {
        ...
        if ('HTML' === k.nodeName && !w(j)) {
            var n = q(a.ownerDocument), o = n.height, p = n.width;
...
var B = function () {
    for (var a = ['Edge', 'Trident', 'Firefox'], b = 0; b < a.length; b += 1)if (e && 0 <= navigator.userAgent.indexOf(a[b]))return 1;
    return 0
}();
function C(a) {
    var b = !1;
...
var E = e && window.Promise, F = E ? C : D;
function G(a, b) {
...
function I(a) {
    var b;
    if ('HTML' === a.nodeName) {
        var c = q(a.ownerDocument), d = c.width, e = c.height;
...
function M(a, b, c) {
    var e = 3 < arguments.length && arguments[3] !== void 0 ? arguments[3] : null, f = e ? x(b) : l(b, d(c));
    return u(c, f, e)
}
function N(a) {
