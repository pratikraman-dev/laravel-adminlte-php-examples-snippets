...
(function (a, b) {
    ...
    function s(a) {
        var b = 1 < arguments.length && arguments[1] !== void 0 && arguments[1], c = a.ownerDocument.documentElement, d = r(a, c), e = R(c.clientWidth, window.innerWidth || 0), f = R(c.clientHeight, window.innerHeight || 0), g = b ? 0 : k(c), h = b ? 0 : k(c, 'left'), i = {
    ...
    function A(a) {
        var b;
        if ('HTML' === a.nodeName) {
            var c = o(a.ownerDocument), d = c.width, e = c.height;
    ...
    function E(a, b, c) {
        var d = 3 < arguments.length && arguments[3] !== void 0 ? arguments[3] : null, f = d ? u(b) : j(b, e(c));
        return r(c, f, d)
    }
    ...
    var R = Math.max, S = 'undefined' != typeof window && 'undefined' != typeof document && 'undefined' != typeof navigator, T = S && !!(window.MSInputMethodContext && document.documentMode), U = S && /MSIE 10/.test(navigator.userAgent), V = Object.assign || function (a) {
            for (var b, c = 1; c < arguments.length; c++)for (var d in b = arguments[c], b)Object.prototype.hasOwnProperty.call(b, d) && (a[d] = b[d]);
            return a
        }, W = function () {
        for (var a = ['Edge', 'Trident', 'Firefox'], b = 0; b < a.length; b += 1)if (S && 0 <= navigator.userAgent.indexOf(a[b]))return 1;
        return 0
    }(), X = S && window.Promise, Y = X ? function (a) {
        var b = !1;
        return function () {
