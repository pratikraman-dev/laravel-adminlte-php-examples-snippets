...
@section('content_header')
    ...
    <section class="content">
        <div class="container-fluid">
                ...
                <div class="col-md-12">
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-12 col-md-6">
                                    <h4 class="mt-4">Primary Navbar
                                        <small><b>recommended</b> (navbar-primary navbar-dark)</small>
                                    </h4>
                            ...
                            <div class="row">
                                <div class="col-12 col-md-6">
                                    <h4 class="mt-4">Orange Navbar
                                        <small><b>recommended</b> (navbar-orange navbar-light)</small>
                                    </h4>
            ...
            <div class="row">
                <div class="col-12">
                    <h4>Nav Tabs inside Card Header
            ...
            <div class="card card-primary card-outline">
                ...
                <div class="card-body">
                    ...
                    <h4 class="mt-4">Right Sided
                        <small>(nav-tabs-right)</small>
                    </h4>
                    <div class="row">
                        <div class="col-7 col-sm-9">
